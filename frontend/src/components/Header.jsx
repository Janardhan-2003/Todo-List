  ...
  return (
    <div className='flex justify-between items-center bg-white p-4 shadow-md w-full px-10 sticky left-0'>
        ...
        <div className='flex gap-4'>
            <p>Home</p>
            <p>about</p>
            <button className='bg-red-500 text-white w-20 h-8 rounded-2xl font-medium font-serif text-shadow-slate-950 shadow-md hover:bg-red-600 cursor-pointer border border-slate-900'
